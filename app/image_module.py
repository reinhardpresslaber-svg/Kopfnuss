...
- Entscheide bewusst zwischen 1 oder 2 Personen, je nachdem was inhaltlich besser passt - NICHT automatisch immer 2 Personen zeigen. Geht es im Thema eher um ein inneres Erleben oder eine individuelle Gewohnheit EINER Person (z.B. Prokrastination, Selbstzweifel, eigene Denkmuster, eine persoenliche Entscheidung), zeige NUR EINE Person - das wirkt oft eindringlicher als ein Duo. Geht es dagegen um zwischenmenschliche Dynamik, Vergleich oder Interaktion (z.B. Streit, Missverstaendnis, soziale Erwartung), passen 2 Personen besser. Die Person(en) sollen sympathisch, authentisch wirken (natuerliche Ausstrahlung, KEIN aufgesetztes Stock-Foto-Laecheln), Situation/Gesichtsausdruck faengt das Thema emotional ein
...
- Falls du dich fuer 2 Personen entscheidest: Variiere bewusst die Konstellation von Bild zu Bild - NICHT immer ein gemischtgeschlechtliches Mann-Frau-Duo, sondern abwechselnd auch mal zwei Frauen, zwei Maenner, unterschiedliche Altersgruppen/Erscheinungsbilder. Insgesamt divers und nicht immer denselben Personentyp zeigen
